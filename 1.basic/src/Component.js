...
export class PureComponent extends Component {
	shouldComponentUpdate(nextProps, nextState) {
		let oldKeyLength = Object.keys(this.props).length;
		let newKeyLength = Object.keys(nextProps).length;
		...
		oldKeyLength = Object.keys(this.state).length;
		newKeyLength = Object.keys(nextState).length;
		if (oldKeyLength !== newKeyLength) {
			return true;
		}
